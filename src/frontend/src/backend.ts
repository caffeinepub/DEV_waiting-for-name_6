...
export class Backend implements backendInterface {
    ...
    async __tokenStore(): Promise<any> {
        if (this.processError) {
            try {
                const result = await this.actor.__tokenStore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async create_event(arg0: string, arg1: string, arg2: string): Promise<CreateEventResult> {
        if (this.processError) {
            try {
                const result = await this.actor.create_event(arg0, arg1, arg2);
                return from_candid_CreateEventResult_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async exchange_auth_code(arg0: string): Promise<ExchangeResult> {
        if (this.processError) {
            try {
                const result = await this.actor.exchange_auth_code(arg0);
                return from_candid_ExchangeResult_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async get_connection_status(): Promise<ConnectionStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.get_connection_status();
                return from_candid_ConnectionStatus_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_CreateEventResult_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreateEventResult): CreateEventResult {
